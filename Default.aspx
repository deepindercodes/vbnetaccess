                    ...
                    <asp:Repeater ID="reparticles" runat="server">
                        <ItemTemplate>
                            <li class='list-group-item p-2'>
                                <div class='row'>
                                    <div class='col-sm-10'><%# DataBinder.Eval(Container.DataItem, "articletitle") %></div>
                                    <div class='col-sm-2 text-center'><a href='javascript:void(0)' onclick='openEditingPanel(<%# DataBinder.Eval(Container.DataItem, "id") %>)'>Edit</a>&nbsp;<a href='delarticle.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick='return confirmDelete()'>Delete</a>&nbsp;<a href='view.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' target='_blank'>View</a></div>
                                </div>
                            </li>
                        </ItemTemplate>
                    </asp:Repeater>
